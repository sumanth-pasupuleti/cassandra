...
public class UUIDSerializerOld implements IVersionedSerializerOld<UUID>
{
    public static UUIDSerializerOld serializer = new UUIDSerializerOld();
    ...
    {
        return TypeSizesOld.NATIVE.sizeof(uuid.getMostSignificantBits()) + TypeSizesOld.NATIVE.sizeof(uuid.getLeastSignificantBits());
    }
}