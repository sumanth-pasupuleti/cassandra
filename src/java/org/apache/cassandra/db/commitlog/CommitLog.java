...
public class CommitLog implements CommitLogMBean
{
     ...
     */
    public void forceRecycleAllSegments(Iterable<UUID> droppedTables)
    {
     ...
     */
    public void discardCompletedSegments(final UUID id, final CommitLogPosition lowerBound, final CommitLogPosition upperBound)
    {
