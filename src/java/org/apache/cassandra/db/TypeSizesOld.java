...
public abstract class TypeSizesOld
{
    public static final TypeSizesOld NATIVE = new NativeDBTypeSizes();
    public static final TypeSizesOld VINT = new VIntEncodedTypeSizes();
    ...
    public static class NativeDBTypeSizes extends TypeSizesOld
    {
    ...
    public static class VIntEncodedTypeSizes extends TypeSizesOld
    {
        private static final int BOOL_SIZE = 1;
